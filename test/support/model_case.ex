defmodule ElixirElmBootstrap.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import ElixirElmBootstrap.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ElixirElmBootstrap.ErrorHelpers.translate_error/1)
