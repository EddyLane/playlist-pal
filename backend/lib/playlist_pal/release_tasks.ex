defmodule PlaylistPal.ReleaseTasks do
  @moduledoc """
  ...
  def seed do
    # Load the code for PlaylistPal, but don't start it
    IO.write "> Loading PlaylistPal..."
    :ok = Application.load(:playlist_pal)
    IO.puts " Done."
  ...
  def priv_dir, do: Application.app_dir(:playlist_pal, "priv")
